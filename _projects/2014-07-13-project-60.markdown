...
description:
  ...
  - My primary contribution to the production was developing the software which mapped the actor's position data,gathered from the Kinect, unto the custom geometry projection surface.
